...
public class AttacksTest {
    ...
    @Test
    public void testMaskRotated90DegreesLeft() throws IOException {
        assertFileEqualsString("/bitmasks-rotated-90-degrees-right.txt",
                maskAsHumanReadableString(attacks.mask90));
    }
    
    @Test
    public void testMaskRotated45DegreesRight() throws IOException {
        assertFileEqualsString("/bitmasks-rotated-45-degrees-right.txt",
                maskAsHumanReadableString(attacks.mask45R));
    }

    @Test
    public void testMaskRotated45DegreesLeft() throws IOException {
        assertFileEqualsString("/bitmasks-rotated-45-degrees-left.txt",
    ...
    public void testGenBaseAttacks(){
        assertFileEqualsString("/correct-base-attacks.txt",
    ...
    private void assertBlockedAttacksEqualMovesFromFile(String attackDescription,
        ...
        try (BufferedReader br = new BufferedReader(
                new InputStreamReader(this.getClass().getResourceAsStream(dataFile))))
        {
            while (br.ready())
            {
    ...
    private void assertAttacksEqualMovesFromFile(String pieceName, String dataFile, long[] attacksFromPiece)
    {
    ...
    private void assertAttacksEqualMovesFromFile(String pieceName, String dataFile,
