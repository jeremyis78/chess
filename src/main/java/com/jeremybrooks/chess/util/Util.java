...
public class Util {
	...
	public static boolean setupState(GameState gameState, String startState) {
        ...
        log.info("position.substring(0, position.length()-2)    : {}, ", position.substring(0, position.length()-2));
	    log.info("initialState.substring(0, position.length()-2): {}", initialState.substring(0, position.length()-2));
    //assert(position.substring(0, position.length()-2) == initialState.substring(0, position.length()-2));
