...
public class MaterialAdjustmentTerm extends EvalTerm {
    ...
    public static final int PAWN_COUNT_BOUNDARY = 5;
    public static final int KNIGHT_ADJUSTMENT_PER_PAWN = 6; //ideally 6.25
    public static final int ROOK_ADJUSTMENT_PER_PAWN = 13;  //ideally 12.5
